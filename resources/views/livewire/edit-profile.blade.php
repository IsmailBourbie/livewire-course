    ...
    <div class="p-16 bg-white rounded-lg shadow-xl w-5/12">
        ...
        <form action="" method="post" class="space-y-6" wire:submit.prevent="update">
            ...
            <div class="w-full flex space-x-2">
                <button type="submit"
                        class="w-full py-2 px-6 text-center text-sm font-medium rounded-lg border border-transparent bg-blue-400 text-blue-800 hover:bg-blue-300 focus:outline-none focus:bg-blue-200 disabled:opacity-50 disabled:pointer-events-none">
                    Update
                </button>
                <button type="reset"
